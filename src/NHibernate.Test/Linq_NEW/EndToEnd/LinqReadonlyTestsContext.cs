...
namespace NHibernate.Test.Linq_NEW.EndToEnd
{
	...
	public class LinqReadonlyTestsContext
	{
		...
		private static void ExecuteScriptFile(Configuration configuration, string scripFileName)
		{
		...
		private static string GetScripFileName(Configuration configuration,string postFix)
		{
		...
		private static void CreateTestData(ISessionFactory sessionFactory)
		{
